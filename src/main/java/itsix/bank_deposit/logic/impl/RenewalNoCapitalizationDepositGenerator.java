...
public class RenewalNoCapitalizationDepositGenerator implements IDepositGenerator, Serializable {
	...
	public RenewalNoCapitalizationDepositGenerator(IDepositBuilder depositBuilder) {
	...
	public IDeposit build(IInnerProduct product, IClient selectedClient, ICurrency currency,
		...
		return depositBuilder.buildRenewalNoCapitalizationDeposit(product, selectedClient, currency, interestCalculator,
				money, period);
	}
