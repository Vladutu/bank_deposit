...
public class InnerDeposit implements IInnerDeposit, Serializable {
	...
	public InnerDeposit(IDecimalFormatter decimalFormatter, IInnerPublisher publisher, ICurrency currency,
