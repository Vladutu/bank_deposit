...
public class RenewalCapitalizationDepositGenerator implements IDepositGenerator, Serializable {
	...
	public RenewalCapitalizationDepositGenerator(IDepositBuilder depositBuilder) {
	...
	public IDeposit build(IInnerProduct product, IClient selectedClient, ICurrency currency,
		...
		return depositBuilder.buildRenewalCapitalizationDeposit(product, selectedClient, currency, interestCalculator,
				money, period);
	}
