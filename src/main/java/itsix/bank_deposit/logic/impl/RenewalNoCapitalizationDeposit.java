...
public class RenewalNoCapitalizationDeposit implements IRenewableDeposit, Serializable {
	...
	public RenewalNoCapitalizationDeposit(IInnerProduct product, IClient client, IInnerDeposit innerDeposit,
