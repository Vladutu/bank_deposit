...
public class ClientsController implements IClientsController, Serializable {
    ...
    public ClientsController(IClientRepository clientRepository, IProductRepository productsRepository,
                             IClientBuilder clientBuilder, IClientValidator clientValidator,
    ...
    public void searchClient() {
        ...
        try {
            ...
            mainView.setClientFields(selectedClient.getSsn(), selectedClient.getFirstName(), selectedClient.getLastName(), selectedClient.getAddress(),
